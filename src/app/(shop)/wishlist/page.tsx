      ...
      {loading ? (
        ...
        <>
                  ...
                  <tr key={item.product.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="mx-3 font-semibold">{item.count}</div>
          ...
          <div className='flex justify-between items-center mt-10'>
            <h2 className='text-4xl lg:text-6xl text-green-500 my-10'>
              Total Price: ${cart?.totalCartPrice}
            </h2>
            <Button className='bg-green-500 text-xl lg:text-3xl text-white hover:bg-black hover:text-green-500 transition-all duration-200 px-6 py-3'>
